...
def genre_extraction(anime_data):
    genre_type = []
    genre_type.insert(0,anime_data['genre'].str.split(',').astype(str))

    anime_type = anime_data.loc[anime_data['type'] == 'Movie']
    genre_type.insert(1,anime_type['genre'].str.split(',').astype(str))

    anime_type = anime_data.loc[anime_data['type'] == 'Music']
    genre_type.insert(2,anime_type['genre'].str.split(',').astype(str))

    anime_type = anime_data.loc[anime_data['type'] == 'ONA']
    genre_type.insert(3,anime_type['genre'].str.split(',').astype(str))

    anime_type = anime_data.loc[anime_data['type'] == 'OVA']
    genre_type.insert(4,anime_type['genre'].str.split(',').astype(str))

    anime_type = anime_data.loc[anime_data['type'] == 'Special']
    genre_type.insert(5,anime_type['genre'].str.split(',').astype(str))

    anime_type = anime_data.loc[anime_data['type'] == 'TV']
    genre_type.insert(6,anime_type['genre'].str.split(',').astype(str))
    return genre_type
